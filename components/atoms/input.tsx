...
const Input = ({
  ...
  return (
    <>
      <div className={`relative flex items-center ${simple? "sm:w-full shadow-md":"shadow-sm"}`}>
      <div
          className={
        ...
        <input
          ...
          min="0"
          type={type}
          className={`${simple? "border border-gray-400 border-r-0 text-xl" : "focus:ring-2 focus:ring-gray-700 text-lg"} min-h-[60px] m-0 w-full appearance-none px-3 py-2 pr-14 text-right placeholder-neutral-300 shadow-sm focus:outline-none `}
          required={isRequired}
          onWheel={(e: any) => {
            e.target.blur();
          }}
