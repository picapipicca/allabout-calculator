...
const BmiDetail = ({height,weight,calculateBmi,calculatePipw}:BmiDetailProps) => {
  return (
      ...
      <div
        ...
        className="block mx-auto max-w-sm p-6 cursor-context-menu bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      >
